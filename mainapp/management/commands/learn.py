...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        action_1_condition = Q(order__update_at__lte=F('order_create_at') + action_1_timedelta)
        action_2_condition = Q(order__update_at__gt=F('order_create_at') + action_1_timedelta) & \
                             Q(order__update_at__lte=F('order_create_at') + action_2_timedelta)
        action_3_condition = Q(order__update_at__gt=F('order_create_at') + action_2_timedelta)
