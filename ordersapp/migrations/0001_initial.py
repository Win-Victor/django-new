# Generated by Django 3.2 on 2022-01-05 13:07
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', models.CharField(choices=[('FM', 'формируется'), ('STP', 'отправлено на обработку'), ('PRD', 'обработано'), ('PD', 'оплачено'), ('CNL', 'отменено'), ('DN', 'завершено')], default='FM', max_length=3)),
